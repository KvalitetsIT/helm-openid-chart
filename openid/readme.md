...
`openid.cookieSecret` | secret value for cookie sessions                                                                                                                                                                                                                           | 
`openid.cookieSecret.key` | Key of the SecretKeyRef                                                                                                                                                                                                                                    | 
`openid.cookieSecret.name` | Name of the SecretKeyRef                                                                                                                                                                                                                                   |
`openid.oidcIssuerUrl` | Path to the IdP                                                                                                                                                                                                                                            | 
`openid.ClientId` | OpenID Client ID                                                                                                                                                                                                                                           |
`openid.ClientSecret` | OpenID Client Secret                                                                                                                                                                                                                                       | 
`openid.ClientSecret.key` | Key of the SecretKeyRef                                                                                                                                                                                                                                    | 
...
`openid.image.tag` | 
`openid.sessionStorage.type` | Session data storage backend; redis or cookie. Default: cookie                                                                                                                                                                                             | `redis` |
`openid.sessionStorage.redis` | Setting for using redis                                                                                                                                                                                                                                    | |
`openid.sessionStorage.redis.existingSecret` | Existing secret name for redis password                                                                                                                                                                                                                    | `"redis-password"`|
`openid.sessionStorage.redis.clientType` | Type of redis standalone, sentinel or cluster                                                                                                                                                                                                              | `"sentinel"`|
`openid.sessionStorage.redis.sentinel` | Settings for Redis Sentinel                                                                                                                                                                                                                                | 
`openid.sessionStorage.redis.sentinel.masterName` | Name of the Redis Sentinel Master                                                                                                                                                                                                                          | `"mymaster"`|
`openid.sessionStorage.redis.sentinel.password` | Is Redis Sentinel using password                                                                                                                                                                                                                           | `true`|
`openid.sessionStorage.redis.sentinel.connectionUrls` | Connection URLs for Redis Sentinel                                                                                                                                                                                                                         | `"redis://redis-node-0.redis-headless:26379,redis://redis-node-1.redis-headless:26379,redis://redis-node-2.redis-headless:26379"`|
&nbsp; |
